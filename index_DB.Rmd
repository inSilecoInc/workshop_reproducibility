...
## `r rfa("database")` &nbsp; `r rfa("file-csv")` &nbsp; `r rfa("file-code")` &nbsp; `r rfa("cogs")` &nbsp; `r rfa("chart-bar")` &nbsp; `r rfa("table")` &nbsp; `r rfa("file-pdf")`
...
- Instruction exercices, j'aime l'idée: https://nicolascasajus.fr/mastering-markdown/instructions_ex3.pdf
